    ...
    <div class="py-12">
        <div class="max-w-5xl space-x-5 flex mx-auto items-start mb-6">
            <div class="w-10/12 flex flex-col space-y-6 mx-auto">
                <a href="{{ route('admin-categories-index') }}" class="underline">
                    ...
                    <div class="bg-neutral-50 border rounded-xl shadow p-3">
                        <div class="text-xl font-semibold flex justify-between">
                            ...
                            <div class="flex space-x-4">
                                ...
                                <form action="{{ route('admin-categories-destroy', $category->id) }}" method="POST">
                                    @csrf
                                    @method('delete')
                                    <button href="{{ route('admin-categories-edit', $category->id) }}"
                                        class="rounded-lg bg-rose-600 font-semibold text-white px-3 py-1" type="submit">
                                        Delete
                                    </button>
                                </form>
                            </div>
                        ...
                        <div class="flex-col flex my-1">
                            ...
                            <input type="text" id="name" name="name"
                                class="border-neutral-200 rounded-xl focus:ring-purple-500"
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="flex w-full">
                                        ...
                                        <select class="border-neutral-200 rounded-xl focus:ring-purple-500 w-1/3"
                                            ...
                                            <option value="{{ $spec->datatype }}">{{ ucfirst($spec->datatype) }}
                                            </option>
                                        </select>
                                    </div>
                                    @if ($spec->datatype == 'number')
                                        <div class="flex w-full">
                                            ...
                                            @if ($spec->compare_logic == '>')
                                                <input type="text"
                                                    class="border-neutral-200 rounded-xl focus:ring-purple-500 w-1/2"
                                                    value="> More is better" disabled>
                                            @else
                                                <input type="text"
                                                    class="border-neutral-200 rounded-xl focus:ring-purple-500 w-1/2"
                                                    value="< Less is better" disabled>
                                            @endif
                                        </div>
                                    @endif
                                </div>
