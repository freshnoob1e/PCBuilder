...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-slate-900	">
        ...
        <br/>
            <p class ="text-slate-50 text-center text-4xl">Cpu/Processor <p/>
        <br/>
        <br/>
              <p class ="text-slate-50 text-center text-4xl">TEAM BLUE or TEAM RED? <p/>
         <br/>
         <br/>

                 <div class= "flex flex-row px-96 space-x-96  ">
                    <img src="{{asset('storage/images/parts/1647292556_Intel i5-12600.webp')}}">
                    <img src="{{asset('storage/images/parts/1647292211_Ryzen 5 5600X.webp')}}">

        </div>
        <br/>
        <br/>
              <p class ="text-slate-50 text-center text-4xl"> Motherboards <p/>
        <br/>
        <br/>
        <br/>
        <br/>
        ...
        <br/>
        <br/>
              <p class ="text-slate-50 text-center text-4xl"> Motherboards form factor</p>
                <br/>
              <p class ="text-slate-50 text-center text-2xl">form factor should be considered when choosing
                  a motherboard as smaller boards<br/>can fit less ram and have smaller gpu slot as
                  well as fewer SATA connections  <p/>
                  <br>
              <p class ="text-slate-50 text-center text-2xl">These are the most commonly used form factors for a standard
                   desktop computer</p>
                  <ul class="text-slate-50 text-center text-2xl ">
                      <li>•Mini ITX</li>
                      <li>•Micro ATX</li>
                      <li>•ATX</li>
                      <li>•EATX</li>
             ...
             <p class="text-slate-50 text-center text-4xl"> Motherboard Compatibility</p>
             <br/>

             <p class="text-slate-50 text-center text-2xl"> Aside from size, motherboards have different sockets
            ...
            <p class="text-slate-50 text-center text-4xl">RAM</p>
            <p class="text-slate-50 text-center text-2xl">RAM, or Random Access Memory, is often
                 misunderstood and can be confusing when it comes to speeds and what it’s compatible with.</p>
                <br/>
                <br/>
            <p class="text-slate-50 text-center text-4xl">Capacity</p>
            </br>
            <p class="text-slate-50 text-center text-2xl">Most casual users won't have to think about running out
                ...
                <br/>
                <br/>
            <p class="text-slate-50 text-center text-4xl">Speed</p>
            <br/>
            <p class="text-slate-50 text-center text-2xl">When it comes to RAM, the most important element is speed.
                ...
                <br/>
                <br/>
            <p class="text-slate-50 text-center text-4xl">Channels: Dual or Quadruple</p>
            <br/>
            <p class="text-slate-50 text-center text-2xl">Double and quadruple channel RAM kits are also common, providing for
                ...
                <p class="text-slate-50 text-center text-4xl"> Graphic cards</p>
                <br/>
                <p class="text-slate-50 text-center text-2xl">Graphic card plays a big role a boosting a
                ...
                <br/> <br/>
                <br/> <br/>
                <p class="text-slate-50 text-center text-4xl">Does a case really matter?</p>
                <br/>

                <p class="text-slate-50 text-center text-2xl">OF COURSE ! there are 3 main things you need
                ...
                <p class="text-slate-50 text-center text-4xl">Cooling</p>
                <br/>
                <p class="text-slate-50 text-center text-2xl">When buying a case, it typically
                ...
                <p class="text-slate-50 text-center text-4xl">PSU</p>
                <br/>
                <P class="text-slate-50 text-center text-2xl">Components have specific power requirements,
                ...
                <p class="text-slate-50 text-center text-4xl">Storage</p>
                <br/>
                <P class="text-slate-50 text-center text-2xl">There are 2 types of storage. HDD and SSD.
